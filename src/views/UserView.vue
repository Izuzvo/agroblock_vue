<template>
  ...
  <header class="bg-gradient-dark">
    <div class="page-header min-vh-75" style="background-image: url('/img/rancho-wall.jpg');" loading="lazy">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <h1 class="text-white">Digitaliza tus cosechas</h1>
            <p class="lead mb-4 text-white opacity-8">Somo una DaApp que te permitira llevar un control en la informacion de calidad, seguridad, y mejora del proceso de tu sembradio</p>
            <button type="submit" class="btn bg-white text-dark">Contactanos!</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-2 col-sm-6">
          <div class="card h-100">
            <a id="btn" class="card-body border-0 rounded" href="/user/tiempo">
              ...
              <p class="mt-4 mb-0 font-weight-bold">Tiempo</p>
              <span class="text-xs">Ultima actualizacion: 2 dias</span>
            </a>
          </div>
        </div>
        <div class="col-lg-2 col-sm-6">
          <div class="card h-100">
            <a id="btn" class="card-body border-0 rounded" href="/user/transpiracion">
              <div class="d-flex mb-4">
                <p class="mb-0">Off</p>
                <div class="form-check form-switch ms-auto">
                  <input class="form-check-input" type="checkbox" id="flexSwitchCheckHumidity">
              ...
              <p class="mt-4 mb-0 font-weight-bold">Transpiracion</p>
