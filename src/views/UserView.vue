        ...
        <div class="col-lg-2 col-sm-6">
          <div class="card h-100">
            <a id="btn" class="card-body border-0 rounded" href="/user/tiempo">
              ...
              <p class="mt-4 mb-0 font-weight-bold">Consumo de agua</p>
        ...
        <div class="col-lg-2 col-sm-6">
          <div class="card h-100">
            <a id="btn" class="card-body border-0 rounded" href="/user/transpiracion">
              ...
              <span class="text-xs">Ultima actualizacion: hace 2 dias</span>
            </a>
          </div>
        </div>
        <div class="col-lg-2 col-sm-6">
          <div class="card h-100">
            <a id="btn" class="card-body border-0 rounded" href="/user/transpiracion">
              ...
              <p class="mt-4 mb-0 font-weight-bold">Tipo de riego</p>
              <span class="text-xs">Ultima actualizacion: hace 2 dias</span>
            </a>
          </div>
        </div>
         <div class="col-lg-2 col-sm-6">
          <div class="card h-100">
            <a id="btn" class="card-body border-0 rounded" href="/user/transpiracion">
              ...
              <p class="mt-4 mb-0 font-weight-bold">Precipitacion</p>
              <span class="text-xs">Ultima actualizacion: hace 2 dias</span>
            </a>
          </div>
        </div>
